...
import static freecall.videocall.freelivechat.global.livecall.dsd14s514.dsa5d145.incoming_counter;
...
import freecall.videocall.freelivechat.global.livecall.fc2ds63526.MainActivity;
...
public class vdsvdv14541 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cg1sdfg5v14);
        ...
        ll_call_accept.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (new dw4sd5sd4(vdsvdv14541.this).getKeyInAppMode().equals("1")) {
                    if (new sdfs21d21().getVipType().equals("in_app_gold") || new sdfs21d21().getVipType().equals("in_app_silver") || new sdfs21d21().getVipType().equals("in_app_bronze")) {
                        ...
                        if (new sdfs21d21().isFreeIncomingActive()) {
                            new sdfs21d21().setFreeIncoming(false);
                            connectVideoCall();
                        } else {
                            startActivity(new Intent(vdsvdv14541.this, MainActivity.class));
                            finish();
                        }
                    }
                } else {
    ...
    private void connectVideoCall() {
        ...
        startActivity(new Intent(vdsvdv14541.this, f4ds6f4ds6f54.class));
        finish();
    }
